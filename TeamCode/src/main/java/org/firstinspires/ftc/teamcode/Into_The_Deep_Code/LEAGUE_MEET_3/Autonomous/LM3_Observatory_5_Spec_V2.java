...
@Disabled
@Autonomous(name = "LM3 - Observatory 5 Spec V2", group = "Autonomous")
public class LM3_Observatory_5_Spec_V2 extends LinearOpMode {

    @Override
    public void runOpMode() {

        Pose2d beginPose = new Pose2d(24, -64, Math.toRadians(275));
        ...
        VelConstraint tempVel = new TranslationalVelConstraint(40);
        AccelConstraint tempAccel = new ProfileAccelConstraint(-40, 40);
...
*/
        ...
        TrajectoryActionBuilder pathActions = drive.actionBuilder(beginPose)
                ...
                .afterTime(0.8, specigrabber.SpecigrabberOpen())
                .waitSeconds(1)
                .setReversed(false)
                ...
                .splineToLinearHeading(new Pose2d(33,-61, Math.toRadians(270)),Math.toRadians(270))

                //pick spec 2
                .waitSeconds(.50)
                .strafeTo(new Vector2d(33, -64.5), tempVel, tempAccel)
                ...
                .setReversed(true)
                .splineToConstantHeading(new Vector2d(1,-33),Math.toRadians(90), tempVel, tempAccel)
                .afterTime(0, specigrabber.SetPosition(var.speciArmScore))
                ...
                //go to spec 3
                .afterTime(0.5,  new ParallelAction(specigrabber.SetPosition(var.speciArmGrab+grabChange), specigrabber.SpeciRotateGrab()))
                .splineToConstantHeading(new Vector2d(33,-61),Math.toRadians(270))
                ...
                //.strafeTo(new Vector2d(35, -60), tempVel, tempAccel)
                .setReversed(true)
                .splineToConstantHeading(new Vector2d(-2,-33),Math.toRadians(90), tempVel, tempAccel)
                .afterTime(0, specigrabber.SetPosition(var.speciArmScore))
                .afterTime(0.4, specigrabber.SpecigrabberOpen())
                .waitSeconds(1)
                .setReversed(false)
                ...
                //go to spec 4
                .afterTime(0.5,  new ParallelAction(specigrabber.SetPosition(var.speciArmGrab+grabChange), specigrabber.SpeciRotateGrab()))
               .splineToConstantHeading(new Vector2d(33,-61),Math.toRadians(270), tempVel, tempAccel)

                //pick spec 4
                .waitSeconds(0.50)
                .strafeTo(new Vector2d(33, -64.75), tempVel, tempAccel)
                .afterTime(0.5, specigrabber.SpecigrabberClose())
                .afterTime(0.8, specigrabber.SetPosition(var.speciArmPrepScore))
                .afterTime(0.8, specigrabber.SpeciRotateScore())
                .waitSeconds(1)
                ...
                //.strafeTo(new Vector2d(35, -60), tempVel, tempAccel)
                .setReversed(true)
                .splineToConstantHeading(new Vector2d(-5,-33),Math.toRadians(90), tempVel, tempAccel)
                .afterTime(0, specigrabber.SetPosition(var.speciArmScore))
                .afterTime(0.4, specigrabber.SpecigrabberOpen())
                .waitSeconds(1)
                .setReversed(false)
                ...
                //.strafeTo(new Vector2d(35, -60), tempVel, tempAccel)
                .setReversed(true)
                .splineToConstantHeading(new Vector2d(-8,-33),Math.toRadians(90), tempVel, tempAccel)
                .afterTime(0,  specigrabber.SetPosition(var.speciArmScore))
                .afterTime(0.4, specigrabber.SpecigrabberOpen())
                .waitSeconds(1)
                .setReversed(false)

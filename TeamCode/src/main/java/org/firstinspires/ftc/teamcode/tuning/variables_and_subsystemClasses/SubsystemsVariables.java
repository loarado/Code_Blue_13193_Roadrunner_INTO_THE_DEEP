...
public class SubsystemsVariables {
    ...
    public final double OuttakeElbowPos = 0.45;

    public final double IntakeElbowPos = 0.13;

    public final double PrepIntakeElbowPos = 0.2;
    ...
    public final int hSlidePhysicalMax = 665;
    public final double hSlideSpeed = 0.5;
    public final double hSlideVelocity = 1300;

    public final int vSlidePhysicalMax = 3700;
    ...
    public final double slidesLength = 22.5;

...
public class LM3_Observatory_5_Spec_V3 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        VelConstraint tempVel = new TranslationalVelConstraint(50);
        AccelConstraint tempAccel = new ProfileAccelConstraint(-50, 50);
...
*/
        ...
        TrajectoryActionBuilder pathActions = drive.actionBuilder(beginPose)
                ...
                .waitSeconds(0.2)
                .strafeToLinearHeading(new Vector2d(29,-48), Math.toRadians(-45), tempVel, tempAccel)
                .splineToLinearHeading(new Pose2d(31,-42, Math.toRadians(45)),Math.toRadians(235), tempVel, tempAccel)
                .strafeTo(new Vector2d(38, -42), tempVel, tempAccel)
                .strafeToLinearHeading(new Vector2d(41,-48),Math.toRadians(-45), tempVel, tempAccel)
                .splineToLinearHeading(new Pose2d(40,-41, Math.toRadians(45)),Math.toRadians(235), tempVel, tempAccel)
                .strafeTo(new Vector2d(46.25, -41), tempVel, tempAccel)
                .strafeToLinearHeading(new Vector2d(44.5,-49), Math.toRadians(-45), tempVel,tempAccel)

                //go to spec 2
                .afterTime(0, hslide.HSlideTo0())
                .afterTime(0, wrist.WristMiddle())
                .afterTime(0, elbow.ElbowMiddle())
                .splineToLinearHeading(new Pose2d(33,-61, Math.toRadians(270)),Math.toRadians(270), tempVel, tempAccel)
                ...
                .setReversed(true)
                .strafeTo(new Vector2d(1,-32.5), tempVel, tempAccel)
                ...
                //.strafeTo(new Vector2d(35, -60), tempVel, tempAccel)
                .setReversed(true)
                .strafeTo(new Vector2d(-2,-32.5), tempVel, tempAccel)
                .afterTime(0.3, specigrabber.SetPosition(var.speciArmScore))
                .afterTime(0.7, specigrabber.SpecigrabberOpen())
                .waitSeconds(0.7)
                .setReversed(false)
                ...
                //pick spec 4
                .waitSeconds(0.50)
                .strafeTo(new Vector2d(33, -64.3), tempVel, tempAccel)
                .afterTime(0.5, specigrabber.SpecigrabberClose())
                .afterTime(0.8, specigrabber.SetPosition(var.speciArmPrepScore))
                .afterTime(0.8, specigrabber.SpeciRotateScore())
                .waitSeconds(0.8)
                ...
                //.strafeTo(new Vector2d(35, -60), tempVel, tempAccel)
                .setReversed(true)
                .strafeTo(new Vector2d(-5,-32.5), tempVel, tempAccel)
                .afterTime(0.3, specigrabber.SetPosition(var.speciArmScore))
                .afterTime(0.7, specigrabber.SpecigrabberOpen())
                .waitSeconds(0.7)
                .setReversed(false)
